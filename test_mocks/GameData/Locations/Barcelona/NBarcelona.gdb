NBarcelona
{
  ...
  TrackName = Barcelona National
  GrandPrixName = Barcelona National
  EventName = Barcelona National
  VenueName = Barcelona National
  Location = Spain, Barcelona
  Length = 1.912 m./3.075 km.

  SettingsFolder = Barcelona
  SettingsCopy = Barcelona.svm
  SettingsAI = Barcelona.svm
  Qualify Laptime = 66.00
  Race Laptime = 68.000
