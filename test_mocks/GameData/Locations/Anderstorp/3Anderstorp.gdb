3Anderstorp
{
  ...
  TrackName = Anderstorp, 2003 FIA GT Championship Round 7
  GrandPrixName = Anderstorp, 2003
  EventName = Round 7: ANDERSTORP
  VenueName = Anderstorp GP, 2003
  Location = Sweden, Anderstorp
  Length = 2.501 mi/4.025 km
  Track Record = Walter Lechner Jr, 1:28.899, #002 Saleen S7-R

  SettingsFolder = Anderstorp
  SettingsCopy = Anderstorp.svm
  SettingsAI = Anderstorp.svm
  Qualify Laptime = 84.000
  Race Laptime = 86.000
