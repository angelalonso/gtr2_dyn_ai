3Magny
{
  ...
  TrackName = Magny-Cours, 2003 FIA GT Championship Round 2
  GrandPrixName = Magny-Cours, 2003
  EventName = Round 2: MAGNY-COURS
  VenueName = Magny-Cours GP, 2003
  Location = France, Magny-Cours
  Length = 2.741 mi/4.411 km
  Track Record = Matteo Bobbi, 1:38.625, #023 Ferrari 550 Maranello
