3Brno
{
  ...
  TrackName = Brno, 2003 FIA GT Championship Round 4
  GrandPrixName = Brno, 2003
  EventName = Round 4: BRNO
  VenueName = Brno GP, 2003
  Location = Czech Republic, Brno
  Length = 3.357 m./5.403 km.
  Track Record = Jean-Marc Gounon, 1:56.695, #002 Saleen S7-R
