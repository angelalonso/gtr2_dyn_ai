4NAValencia
{
  ...
  TrackName = Valencia National
  GrandPrixName = Valencia National
  EventName = Valencia National
  VenueName = Valencia National
  Location = Spain, Valencia
  Length = 1.939 m. /3.121 km.

  SettingsFolder = Valencia
  SettingsCopy = Valencia.svm
  SettingsAI = Valencia.svm
  Qualify Laptime = 70.000
  Race Laptime = 72.000
