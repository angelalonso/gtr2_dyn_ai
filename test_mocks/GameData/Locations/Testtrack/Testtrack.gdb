Testtrack
{
  ...
  TrackName = Testtrack, 2004 FIA GT Championship Round 1
  GrandPrixName = Testtrack, 2004
  EventName = Round 1: TESTTRACK
  VenueName = Testtrack GP, 2004
  Location = Italy, Testtrack
  Length = 3.585 mi/5.770 km
  Track Record = Fabrizio Gollin, 1:43.509, #002 Ferrari 550 Maranello

  SettingsFolder = Testtrack
  SettingsCopy = Testtrack.svm
  SettingsAI = Testtrack.svm
