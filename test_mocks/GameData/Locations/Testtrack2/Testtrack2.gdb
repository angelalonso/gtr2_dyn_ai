Testtrack2
{
  ...
  TrackName = Testtrack2, 2004 FIA GT Championship Round 1
  GrandPrixName = Testtrack2, 2004
  EventName = Round 1: TESTTRACK
  VenueName = Testtrack2 GP, 2004
  Location = Italy, Testtrack2
  Length = 3.585 mi/5.770 km
  Track Record = Fabrizio Gollin, 1:43.509, #002 Ferrari 550 Maranello

  SettingsFolder = Testtrack2
  SettingsCopy = Testtrack2.svm
  SettingsAI = Testtrack2.svm
