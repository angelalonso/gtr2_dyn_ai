3Spa
{
  ...
  TrackName = Spa-Francorchamps, 2003 FIA GT Championship Round 6
  GrandPrixName = Spa-Francorchamps 2003
  EventName = Round 6: SPA-FRANCORCHAMPS
  VenueName = Spa-Francorchamps GP, 2003
  Location = Belgium, Francorchamps
  Length = 4.330 mi/6.968 km
  Track Record = Fabrizio Gollin, 2:15.718, #022 Ferrari 550 Maranello

  SettingsFolder = Spa
  SettingsCopy = spa.svm
  SettingsAI = spa.svm
  Qualify Laptime = 130.500
  Race Laptime = 132.000
