IDubai
{
  ...
  TrackName = Dubai International
  GrandPrixName = Dubai International
  EventName = Dubai International
  VenueName = Dubai International
  Location = United Arab Emirates, Dubai
  Length = 2.681 m./4.290 km.

  SettingsFolder = Dubai
  SettingsCopy = Dubai.svm
  SettingsAI = Dubai.svm
  Qualify Laptime = 93.500
  Race Laptime = 95.500
