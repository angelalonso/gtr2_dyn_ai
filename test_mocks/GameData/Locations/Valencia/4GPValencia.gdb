4GPValencia
{
  ...
  TrackName = Valencia GP, 2004 FIA GT Championship Round 2
  GrandPrixName = Valencia GP 2004
  EventName = Round 2: Valencia GP
  VenueName = Valencia GP, 2004
  Location = Spain, Valencia
  Length = 2.468 m. /3.972 km.
  Track Record = Michael Bartels, 1:31.368, #005 Saleen S7-R

  SettingsFolder = Valencia
  SettingsCopy = Valencia.svm
  SettingsAI = Valencia.svm
  Qualify Laptime = 90.000
  Race Laptime = 92.000
